...
public class SudokuSolver {
     ...
     * <p>
     * 2.Our â€œcurrent cellâ€� is the first cell in the enumeration.
     * <p>
     ...
     * If not, then go back to step 2 with the â€œcurrent cellâ€� being the next cell.
     * In case b: if the current cell is the first cell in the enumeration, then the Sudoku puzzle does not have a solution.
     * If not, then erase the 9 from the corrent cell, call the previous cell in the enumeration the new â€œcurrent cellâ€�, and
